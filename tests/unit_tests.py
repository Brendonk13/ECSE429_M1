...
import requests
import sys
sys.path.append('./category_tests')
from category_tests.test_categories import random_order_category_test
from category_tests.helpers import verify_service_is_running
